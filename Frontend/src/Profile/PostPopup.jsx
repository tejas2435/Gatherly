...
import { X, Heart, MessageCircle, Share, MapPin, Clock } from 'lucide-react';
...
const PostPopup = ({ post, author, onClose }) => {
    ...
    useEffect(() => {
        if (post?.image) {
            ...
            img.src = post.image;
            img.onload = () => {
                const height = Math.max(400, img.height);
    ...
    useEffect(() => {
        ...
        const checkLiked = async () => {
            const res = await fetch(`${API_URL}/api/posts/${post.id}/liked`, {
    ...
    const handleCommentSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/posts/${post.id}/comment`, {
                method: 'POST',
                headers: {
                        ...
                        <div className={`${imageAspectRatio === 'portrait' ? 'xl:w-3/5' : 'lg:w-2/5'} flex flex-col max-h-[calc(100vh-40px)]`}>
                            ...
                            <div className="p-6 border-b border-gray-100 dark:border-gray-400 flex-shrink-0">
                                <div className="flex items-center gap-3 mb-4">
                                    <img
                                        src={post.author?.profile_photo || "https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg"}
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${liked ? "text-red-500" : "text-gray-500 dark:text-gray-200 hover:text-red-500"}
