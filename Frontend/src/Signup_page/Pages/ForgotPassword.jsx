  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-700 to-indigo-300 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <div className="mt-4 mb-6 p-4 rounded-xl bg-yellow-100 border border-yellow-300 flex items-center gap-3 animate-pulse">
          <span className="bg-yellow-400 text-white px-3 py-1 rounded-lg text-xs font-bold">
            BETA
          </span>

          <p className="text-yellow-800 text-sm font-medium">
            Password recovery is currently under development. Please try again later.
          </p>
        </div>
