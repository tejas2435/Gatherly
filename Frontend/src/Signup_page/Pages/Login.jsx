  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.token) {
        ...
        // Trigger storage event for header updates
      ...
      if (err.response) {
        ...
        setMessage(err.response.data.error || err.response.data.message || "Invalid email or password");
      } else {
    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-3xl font-bold" style={{ color: "rgba(180, 61, 236, 0.9)" }}>Gatherly</p>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              onClick={() => showToast("Facebook login is under development 🚧")}
            ...
            <button
              onClick={() => showToast("Google login is under development 🚧")}
              className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50"
            >
