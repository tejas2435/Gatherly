...
import { Users, HelpCircle, Shield, FileText, AlertCircle, Mail, Globe, Copyright, } from 'lucide-react';
  ...
  const toggleFollow = async (targetUsername) => {
    ...
    try {
      const res = await fetch(
        `${API}/api/follow/${isAlreadyFollowing ? 'unfollow' : 'follow'}/${targetUsername}`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
